define(function(require) {
    ...
    PolarChartComponent = BaseChartComponent.extend({
        /**
         *
         * @overrides
        ...
        initialize: function(options) {
            PolarChartComponent.__super__.initialize.call(this, options);
        },
        ...
        draw: function() {
            ...
            if(this.hasOwnProperty('whoChartedChart')) {
                if(this.whoChartedChart.id in Chart.instances) {
                    ...
                    this.whoChartedChart = new Chart(ctx).PolarArea(data, settings);
                }
            } else {
                this.whoChartedChart = new Chart(ctx).PolarArea(data, settings);
            }
            ...
            if(typeof this.legend !== 'undefined' && this.legendCreated === null) {
                PolarChartComponent.__super__.createLegend.call(this, this.whoChartedChart);
            }
        }
    });
