define(function(require) {
    ...
    RadarChartComponent = BaseChartComponent.extend({
        /**
         *
         * @overrides
        ...
        initialize: function(options) {
            RadarChartComponent.__super__.initialize.call(this, options);
        },
        ...
        draw: function() {
            ...
            if(this.hasOwnProperty('whoChartedChart')) {
                if(this.whoChartedChart.id in Chart.instances) {
                    ...
                    this.whoChartedChart = new Chart(ctx).Radar(data, settings);
                }
            } else {
                this.whoChartedChart = new Chart(ctx).Radar(data, settings);
            }
            ...
            if(typeof this.legend !== 'undefined' && this.legendCreated === null) {
                RadarChartComponent.__super__.createLegend.call(this, this.whoChartedChart);
            }
        }
    });
